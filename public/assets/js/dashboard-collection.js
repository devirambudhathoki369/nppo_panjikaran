...
$(document).ready(function () {
  $.ajax({
    method: "POST",
    url: ajaxURLChart + "get-data-for-collection-dashboard-chart-2",
    data: {
      _token: csrf
    }
  })
          ...
          (areachartSalesColors &&
            ((options = {
              ...
              xaxis: {
                ...
                title: { text: "Collection Data", offsetX: 0, offsetY: -30, style: { color: "#78909C", fontSize: "12px", fontWeight: 400 } },
              },
              yaxis: {
                labels: {
              ...
              (chart = new ApexCharts(document.querySelector("#voucher-transaction-chart-2"), options)).render()));
    })
    .fail(function (resp) {
