...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">पंजीकरण सम्पादन गर्नुहोस्</h4>

            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="{{ route('dataentry.checklists.index') }}">चेकलिस्ट</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('panjikarans.index', $checklist->id) }}">पंजीकरणको विवरण</a></li>
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('panjikarans.update', [$checklist->id, $panjikaran->id]) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <div class="form-floating">
                                <input id="CommonNameOfPesticide" type="text"
                                    ...
                                    name="CommonNameOfPesticide" value="{{ old('CommonNameOfPesticide', $panjikaran->CommonNameOfPesticide) }}"
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-floating">
                                <input id="ChemicalName" type="text"
                                    class="form-control @error('ChemicalName') is-invalid @enderror"
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="form-floating">
                                <input id="IuapcNo" type="number"
                                    class="form-control @error('IuapcNo') is-invalid @enderror"
                                    name="IuapcNo" value="{{ old('IuapcNo', $panjikaran->IuapcNo) }}"
                                    autocomplete="off" placeholder="IUPAC नं">
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="form-floating">
                                <input id="Cas_No" type="text"
                                    ...
                                    autocomplete="off" placeholder="CAS नं">
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="form-floating">
                                <input id="Atomic_Formula" type="text"
                                    ...
                                    name="Atomic_Formula" value="{{ old('Atomic_Formula', $panjikaran->Atomic_Formula) }}"
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-floating">
                                <select id="SourceID" class="form-select @error('SourceID') is-invalid @enderror" name="SourceID">
                                    <option value="">स्रोत छान्नुहोस्</option>
                                    @foreach($sources as $source)
                                        <option value="{{ $source->id }}" {{ (old('SourceID') ?? $panjikaran->SourceID) == $source->id ? 'selected' : '' }}>
                                            {{ $source->sourcename }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-floating">
                                <select id="CategoryID" class="form-select @error('CategoryID') is-invalid @enderror" name="CategoryID">
                                    <option value="">श्रेणी छान्नुहोस्</option>
                                    @foreach($categories as $category)
                                        <option value="{{ $category->id }}" {{ (old('CategoryID') ?? $panjikaran->CategoryID) == $category->id ? 'selected' : '' }}>
                                            {{ $category->prakar }}
                                        </option>
                                    @endforeach
                                </select>
