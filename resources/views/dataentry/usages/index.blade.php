    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">उपयोगको विवरण</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item active">उपयोगको विवरण</li>
                    </ol>
                </div>
            </div>
        </div>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <div class="form-floating">
                                                    <input id="usage_name" type="text"
                                                        ...
                                                        name="usage_name" value="{{ old('usage_name') }}" required
                    ...
                    <table class="table align-middle datatable dt-responsive table-check nowrap"
                        ...
                        <thead>
                            <tr class="bg-transparent">
                                <th width="5%">S.N.</th>
                                <th width="50%">उपयोगको नाम</th>
                                <th width="10%"></th>
                                <th width="10%"></th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach ($usages as $sn => $usage)
                                <tr>
                                    <td>{{ ++$sn }}</td>
                                    <td>{{ $usage->usage_name }}</td>
                                    <td>
                                        <a href="{{ route('usages.edit', $usage->id) }}" class="btn btn-success btn-xs"><i
                                                class="bx bx-edit"></i>
                                        </a>
                                    </td>
                                    <td align="center">
