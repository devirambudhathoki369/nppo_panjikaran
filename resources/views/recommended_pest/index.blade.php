...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">सिफारिस गरिएको कीराको सूची</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="{{ route('panjikarans.index') }}">पञ्जीकरणको सूची</a></li>
                        <li class="breadcrumb-item active">सिफारिस गरिएको कीराको सूची</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <!-- Add New RecommendedPest Form -->
    @if ($panjikaranId)
        <div class="row mb-4">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">नयाँ कीरा सिफारिस थप्नुहोस्</h5>
                        ...
                        <tbody>
                            @forelse ($recommendedPests as $sn => $recommendedPest)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('recommended-pests.show', $recommendedPest->id) }}"
